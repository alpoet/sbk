...
<div align="center"><p><h1>邵阳市中心医院设备科设备网上平台数据管理</h1></p></div>


<div class="tabbable">
	<ul class="nav nav-tabs">
      <li class="active"><a href="#bk_view" data-toggle="tab">报库单管理</a></li>
    <div class="pull-right">
      欢迎您 管理员<?php echo ($aid); ?>
      <a href="__URL__/logout" class="btn btn-warning">退出登录</a>
    </div>
    </ul>
    
    <div class="tab-content">
    <div class="tab-pane active" id="bk_view">
    ...
    <?php if(is_array($bkdata)): $i = 0; $__LIST__ = $bkdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tbody>
        <tr>
            <td>
            	<select name="bk_equipment_id[]" class="select-mini select2Buttons">
					<option><?php echo ($vo["bk_equipment_id"]); ?></option>
				</select>		
            </td>
            ...
            <td>            	
            	<select name="bk_equipment_name[]" class="select-mini select2Buttons">
					<option><?php echo ($vo["bk_equipment_name"]); ?></option>
				</select>            	
            </td>

            <td>            	
            	<select name="bk_equipment_specification[]" class="select-mini select2Buttons">
					<option><?php echo ($vo["bk_equipment_specification"]); ?></option>
				</select>
            </td>

            <td>           	
	            <select name="bk_quantity[]" class="select-mini select2Buttons">
	            	<option><?php echo ($vo["bk_quantity"]); ?></option>
	            </select>
            </td>
            
            <td>           	
	            <select name="bk_hospital_departments[]" class="select-mini select2Buttons">
	            	<option><?php echo ($vo["bk_hospital_departments"]); ?></option>
	            </select>
            </td>
            
            <td>           	
	            <select name="bk_data_time[]" class="select-mini select2Buttons">
	            	<option><?php echo ($vo["bk_data_time"]); ?></option>
	            </select>
            </td>
        </tr>
